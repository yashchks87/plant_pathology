...
# python resize_images.py --folder_path ../../../plant_path_data/train_images/ --new_path ../../../plant_path_data/train_images_224/ --cpu_count 10 --store_pickle False --img_size 224